# Referenced from: https://github.com/gortizji/tangent_task_arithmetic/blob/main/src/eval_single_task.py
...
for dataset in [
    ...
    if args.finetuning_mode == "standard":
        for split in ["ImageNet"]:
            name = split+eval_dataset
            accuracies[name] = eval_single_dataset(image_encoder, split, args)["top1"]
